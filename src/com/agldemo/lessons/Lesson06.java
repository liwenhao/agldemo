 ...
 * Lesson 06
 */
public class Lesson06 extends Lesson {
	...
	public Lesson06(Context c) {
		super(c, "Lesson 06", "Texture Mapping");
		mBitmap = BitmapFactory.decodeResource(c.getResources(), R.drawable.robot);
	}
